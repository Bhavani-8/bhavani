...
def mark_complete_bulk_action(driver, wait, dropdown_selection_val_data, dropdown_selection_val=None, task_name='Internal Task', test_case_id=None):
    ...
    with allure.step("Open Bulk Action and select 'Mark Complete'"): 
        ...
        mark_complete_option = wait.until(EC.element_to_be_clickable((By.XPATH, "//div[@class='dx-item-content dx-list-item-content' and text()='Mark Complete']")))
    ...
    with allure.step("Click Confirm button"):
        try:
            ...
            cancel_btn = wait.until(EC.presence_of_element_located((By.XPATH, dash_bulk_options_cancel_btn)))
