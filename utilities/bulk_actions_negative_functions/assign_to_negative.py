...
def assign_to_negative(driver, wait, dropdown_selection_val_data, dropdown_selection_val=None, text_case_id=None):
    ...
    with allure.step("Clicking Assigned To Me Tab"):   
        try:
            ...
            step_fail(driver, "Clicking Assigned To Me Tab failed", e)
    ...
    with allure.step("Select 'Assign' from Column Chooser"):
        try:           
            ...
            step_fail(driver, "Clicking Assigned To option failed", e)
    ...
    with allure.step("Open Approver column filter and search for User"):
        try:  
            ...
            step_fail(driver, "Opening Assigned To filter failed", e)
    ...
    with allure.step("Open Bulk Action and select 'Assig To'"):  
        try:
            ...
            step_fail(driver, "Bulk action failed", e)
