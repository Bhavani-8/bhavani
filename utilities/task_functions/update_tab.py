...
def update_check(driver,task_name=None, start_date=None, due_date=None, frequency=None,
    ...
    with allure.step("Adding Circulars..."):
        print()
    ...
    # Click file tab
        time.sleep(4)
        update_user = wait.until(EC.presence_of_element_located((By.XPATH, task_update_tab)))
        highlight_element(driver, update_user)
        update_user.click()
