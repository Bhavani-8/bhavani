...
def comment_check(driver,task_name=None, start_date=None, due_date=None, frequency=None,
    ...
    with allure.step("Click on Comment"):
        print()
...
# ============================
    ...
    with allure.step("Click on Comment"):
        ...
        # Enter comment text
        comment_text = "This is a test comment1 "
        comment_box.send_keys(comment_text)
        print(f"✅ Comment entered: {comment_text}")
        allure.attach(comment_text, name="Entered Comment", attachment_type=allure.attachment_type.TEXT)
...
# "freq_option": "//div[contains(@class, 'css-1uccc91-singleValue')]",