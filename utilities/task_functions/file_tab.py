...
def file_check(driver,task_name=None, start_date=None, due_date=None, frequency=None,
                  repeat_if_due_date_is_on_holiday=None, end_frequency_date=None,
                  weekday_name=None, repeat_day_and_month=None, task_category=None, filename='dummy_use_file.pdf', dash_type=''):
    ...
    with allure.step("Load locators.json"):
        try:
            ...
            task_file_tab = elements_details["task_file_tab"]
    ...
    with allure.step("Click on File Tab"):
        print()
    # Click file tab
        time.sleep(4)
        file_user = wait.until(EC.presence_of_element_located((By.XPATH, task_file_tab)))
        highlight_element(driver, file_user)
        file_user.click()
        print("✅ File tab clicked successfully.")
    ...
    with allure.step("📤 Upload File"):
        try:
            ...
            highlight_element(driver, file_input)
   ...
   # Validate toast message
    with allure.step("Validate toast notification for creation of a task"):
        toast = wait.until(
            EC.presence_of_element_located(
                (By.XPATH, "//div[contains(@class,'Toastify__toast-body')]")
            )
