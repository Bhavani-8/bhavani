...
at_test_case_list = get_test_case_list(module='special_tp')
...
def test_special_dashboard_flow(setup, test_case_id, module_name, test_case_description, test_type):
    ...
    driver = setup
    test_name = f"special_tp_validation"
    ...
    with allure.step(f"Special Team Performance Flow"):
        try:
            ...
            if test_type == 'positive':
                ...
                assert not success, "Special Team Performance Dashboard succeeded with invalid scenario"
