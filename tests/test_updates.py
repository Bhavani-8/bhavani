...
from utilities.updates_utils import get_test_case_list, updates_check
...
def test_updates_flow(setup, test_case_id, module_name, test_case_description, test_type, task_details):
    ...
    test_name = f"updates_validation"
    ...
    with allure.step(f"Updates Flow"):
        try:
            ...
            if test_type == 'positive':
                # assert True
                   assert success, "Updates Dashboard failed with valid scenario"
